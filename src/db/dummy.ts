export const products = [
    {
      ...
      category: "Mobiles",
      price: 6999,
      imgs:"https://gitcdn.link/cdn/seebham/ecommerce-dummy-data/main/images/redmi9A1.jpg"
       ,
      specs:"13MP rear camera with AI portrait, AI scene recognition, HDR, pro mode | 5MP front camera."
       ,

    ...
    return(
        <nav className="bg-gray-900 p-4 flex justify-between items-center">
            <div className="flex items-center">
                <img src="https://res.cloudinary.com/dbfydxolq/image/upload/v1734592271/merxpressLogo_alez0i.svg" alt="Merxpress Logo" className="h-10" style={{height:"60px",width:"250px"}}/>
            </div>
            <div className="flex items-center space-x-5 ">
                ...
                <div className="relative ">
                    ...
                    {/* <img src='icons/cart-outline.svg' className='h-10 w-10 fill-white '/> */}
                     <ShoppingCart className='w-full h-8 stroke-white hover:fill-red-500 ' strokeWidth={1.0} fill='none' href='/marketplace' />
                ...
                <div className="">
                    ...
                    <Settings className='w-full h-8 stroke-white hover:fill-red-500' strokeWidth={1.0} fill='none' href='null'/> 
